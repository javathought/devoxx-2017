...
.factory('AuthenticationService',
    ['Base64', '$http', '$cookieStore', '$rootScope', '$timeout', 'Users',
    function (Base64, $http, $cookieStore, $rootScope, $timeout, Users) {
        ...
        service.Login = function (username, password, callback, errorcallback) {
            ...
            /* Use this for real authentication
             ----------------------------------------------*/
            $http.post('/myapp/authenticate', { username: username, password: password })
        ...
        service.CheckRoles = function (roles) {
          $rootScope.profileUser = (findWithAttr(roles, "role", "user") > -1);
          $rootScope.profileWrite = (findWithAttr(roles, "role", "super") > -1);
        ...
        service.ClearCredentials = function () {
          ...
          $rootScope.login = false;
            ...
            $http.defaults.headers.common.Authorization = undefined; //'Basic ';
        };

        service.HasRole = function(role) {
          var hasRole = findWithAttr($rootScope.globals.currentUser.roles, 'role', allowed) != -1;
